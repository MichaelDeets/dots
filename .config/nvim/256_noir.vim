...
" 16=black, 255=white, 255=red, 245=darkred.
...
if has("gui_running") || &t_Co == 256
    ...
    hi Number cterm=NONE ctermfg=245 ctermbg=16 gui=NONE guifg=#2f2f2f guibg=#000000
    hi Error cterm=NONE ctermfg=255 ctermbg=245 gui=NONE guifg=#eeeeee guibg=#2f2f2f
    hi ErrorMsg cterm=NONE ctermfg=255 ctermbg=124 gui=NONE guifg=#eeeeee guibg=#6f6f6f
    ...
    hi DiffChange cterm=NONE ctermfg=160 ctermbg=255 gui=NONE guifg=#2f2f2f guibg=#eeeeee
    hi DiffText cterm=bold ctermfg=250 ctermbg=240 gui=bold guifg=#bcbcbc guibg=#2f2f2f
    hi SignColumn cterm=NONE ctermfg=124 ctermbg=240 gui=NONE guifg=#6f6f6f guibg=#585858
    hi SpellBad cterm=undercurl ctermfg=255 ctermbg=245 gui=undercurl guifg=#eeeeee guibg=#2f2f2f
    hi SpellCap cterm=NONE ctermfg=255 ctermbg=124 gui=NONE guifg=#eeeeee guibg=#6f6f6f
    hi SpellRare cterm=NONE ctermfg=124 ctermbg=16 gui=NONE guifg=#6f6f6f guibg=#000000
    ...
    hi Number cterm=NONE ctermfg=Grey ctermbg=Black
    hi Error cterm=NONE ctermfg=White ctermbg=DarkGrey
    hi ErrorMsg cterm=NONE ctermfg=White ctermbg=Grey
    hi Search cterm=NONE ctermfg=Gray ctermbg=DarkGray
    hi IncSearch cterm=reverse ctermfg=White ctermbg=Gray
    hi DiffChange cterm=NONE ctermfg=Grey ctermbg=White
    hi DiffText cterm=bold ctermfg=Gray ctermbg=Grey
    hi SignColumn cterm=NONE ctermfg=Grey ctermbg=DarkGray
    hi SpellBad cterm=undercurl ctermfg=White ctermbg=DarkGrey
    hi SpellCap cterm=NONE ctermfg=White ctermbg=Grey
    hi SpellRare cterm=NONE ctermfg=Grey ctermbg=Black
